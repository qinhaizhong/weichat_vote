	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<?php  if(IMS_FAMILY != 'x') { ?>
				<li><a href="http://www.haoid.cn"><i class="fa fa-comment"></i>微擎论坛</a></li>
				<li><a href="http://www.haoid.cn"><i class="fa fa-comment"></i>好站长资源网</a></li>
				<?php  } ?>
			</ul>
		...
		<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					...
					<?php  if(IMS_FAMILY != 'x') { ?>
						<li><a href="http://www.haoid.cn"><i class="fa fa-comment"></i>微擎论坛</a></li>
						<li><a href="http://www.haoid.cn"><i class="fa fa-suitcase"></i>好站长资源网</a></li>
					<?php  } ?>
				</ul>
				<ul class="nav navbar-nav navbar-right">
